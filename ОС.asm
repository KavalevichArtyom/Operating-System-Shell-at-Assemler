...
; запишем строку в файл
	...
	; 30.05.2018 19.52 mov dx,9	;младшая половина указателя         
	...
	int 21h	
    	...
    	int 21h
    	;30.05.2018  19.40 mov cx,ax	; столько реально прочитали
; запишем строку в файл
...
; откроем файл
	...
	mov cx,0	;старшая половина указателя
	;31.05.2018 22.03 mov dx,9	;младшая половина указателя  
	mov dx,0	;младшая половина указателя
	int 21h	
	...
	;30.05.2018 19.56 mov cx,len	;столько читать 
	mov cx,dlina_stroki	;столько читать
